...
/// @notice This file is modified based on Scroll's contract:
/// https://github.com/scroll-tech/scroll/blob/develop/contracts/src/misc/ScrollOwner.sol
/// non-upgradeable Ownable storage layout to align with initial deployment on Scroll.
contract VesselOwner is AccessControlEnumerable {
